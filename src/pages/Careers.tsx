...
import { Briefcase, MapPin, Clock, Loader2, CheckCircle2, Send, Search } from "lucide-react";
        ...
        <div className="container-custom px-4">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6">
              Build Your Career <span className="text-secondary">With Manvi</span>
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              We're always looking for passionate individuals who share our love for fishing and community building. 
              Join a dynamic team that's shaping the future of recreational fishing in India.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {["Competitive compensation packages", "Flexible working arrangements", "Professional development opportunities", "Access to all club facilities and events"].map((benefit, i) => (
              <div key={i} className="bg-card p-4 rounded-lg border flex items-start gap-3">
